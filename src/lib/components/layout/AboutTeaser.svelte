...
<script lang="ts">
  ...
  name: "Harvey co-founder",
  role: "Co-founder",
  image: "/generated/image-a-professional-founder-dressed-in-a-tail.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"We didn't build one big brain. We built hundreds of small, smart ones—each trained for the task a professional actually needs."`}
      />
